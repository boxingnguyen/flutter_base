...
abstract class $ApiResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? code, dynamic data, String? status, ApiError? error});
...
class _$ApiResponseImpl implements _ApiResponse {
  _$ApiResponseImpl({this.code, this.data, this.status, this.error});
  ...
  @override
  String toString() {
    return 'ApiResponse(code: $code, data: $data, status: $status, error: $error)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, code,
      const DeepCollectionEquality().hash(data), status, error);
...
abstract class _ApiResponse implements ApiResponse {
  factory _ApiResponse(
      ...
      final dynamic data,
      final String? status,
      final ApiError? error}) = _$ApiResponseImpl;
